...
namespace eval ::optrace {
  variable script "D:/codeworkplace/Vivado/EdgeAccelerator/test2/test2.runs/impl_1/test.tcl"
...
OPTRACE "create in-memory project" START { }
  ...
  set_property board_part_repo_paths {D:/codeworkplace/Vivado/lib_board} [current_project]
  set_property board_part seeedstudio.com:spartanedgeacceleratorboard1v0:part0:2.42X [current_project]
...
OPTRACE "set parameters" START { }
  ...
  set_property ip_repo_paths D:/codeworkplace/Vivado/vivado-library-zmod-v2-2019.1-2 [current_project]
  update_ip_catalog
...
OPTRACE "add files" START { }
  add_files -quiet D:/codeworkplace/Vivado/EdgeAccelerator/test2/test2.runs/synth_1/test.dcp
OPTRACE "read constraints: implementation" START { }
OPTRACE "read constraints: implementation" END { }
OPTRACE "add files" END { }
OPTRACE "link_design" START { }
  link_design -top test -part xc7s15ftgb196-1 
