...
*/
// DS pin 14
const int dataPin_74595 = 6;
// ST_CP pin 12
const int latchPin_74595 = 4;
// SH_CP pin 11
const int clockPin_74595 = 3;
/*
              74HC166                              Arduino
        -----------------------                 ---------
...
//Q7 pin 13
const int dataPin_74166 = 5;
//PE pin 15
const int latchPin_74166 = 7;
//CP pin 7
...
void blinkBy74595(unsigned int value){
  ...
  shiftOut(dataPin_74595, clockPin_74595, MSBFIRST, (value >> 8 & 0xff));
  shiftOut(dataPin_74595, clockPin_74595, MSBFIRST, value & 0xff);
